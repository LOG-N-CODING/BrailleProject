    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <div className="flex justify-center mb-6">
            <div className="flex space-x-2">
              <div className="w-8 h-8 bg-gradient-to-r from-primary-400 to-secondary-600 rounded-full"></div>
              <div className="w-8 h-8 bg-gradient-to-r from-secondary-400 to-primary-600 rounded-full"></div>
            </div>
          </div>
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Welcome Back</h1>
          <p className="text-gray-600">Sign in to continue your Braille learning journey</p>
        </div>
        ...
        <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
          <h3 className="text-lg font-semibold text-blue-800 mb-2">New to Braille Learning?</h3>
          <p className="text-blue-700 mb-4">
            You can start learning immediately without creating an account.
          </p>
          <Link
            to="/learn"
