      ...
      <section className="relative flex items-center justify-center bg-white py-12 lg:py-40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            >
              <motion.p className="text-lg sm:text-xl text-gray-700 mb-4" variants={fadeInUp}>
            ...
            >
              <Link to="/learn">
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-medium text-gray-800 mb-3 sm:mb-4 text-center">
                    Learn Braille
                  </h3>
